all:
	...
	@ emcc main.c -o func.js -sEXPORTED_FUNCTIONS="['_get_assemble', '_get_mcode', '_get_length', '_run_compiler', '_get_compiler_diag']" -sEXPORTED_RUNTIME_METHODS=ccall,cwrap -s ALLOW_MEMORY_GROWTH=1 -s ASSERTIONS=1 -s SAFE_HEAP=1 -s TOTAL_STACK=512mb 
